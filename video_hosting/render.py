...
from backends import change_render2
...
def render_video(video_path):
    ...
    if new_clip.size == [1080,1920]:
        new_clip.write_videofile(f'{BASE_DIR}/media/render1/{new_name1}/_{old_name}.mp4')
        change_render2(old_name, new_name1, video_path)
        new_clip.close()
